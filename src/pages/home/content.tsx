...
export const Content: React.FC = () => {
  return (
    <div className='site-content'>
      <Card title={
        <p><i className='iconfont icon-anchorPoint' /> 主题</p>
      }>
        <div className='theme-lists'>
          ...
          <IntroCard thumb={miniprogrameThumb.src} title='小程序开发' subTitle='微信、抖音、百度等' />
        </div>
      </Card>

      <Card title={<p><i className='iconfont icon-introduce' /> 案例</p>}>
        <div className='case-lists'>
          <CaseCard thumb={case01Thumb.src} date='2024-09-05 16:54' title='测试' tags={[
            {
              icon: 'tag',
              label: 'web'
            }
          ]} desc='这个一个web应用' />
           <CaseCard thumb={case02Thumb.src} date='2024-09-05 16:54' title='这是一个非常非常非常非常非常非常长的名字' tags={[
            {
              icon: 'tag',
              label: 'PC'
            }
